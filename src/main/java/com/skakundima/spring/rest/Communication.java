...
public class Communication {
    ...
    public List<Employee> getAllEmployees(){ //посылает Http запрос и получает список всех работников
        ...
        //отправляем запрос и его результат получаем в ResponseEntity
